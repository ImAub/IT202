Pong = {
  ...
  Defaults: {
    ...
    paddleWidth:  12,
    paddleHeight: 60,
    paddleSpeed:  3,     // should be able to cross court vertically   in 2 seconds
    ballSpeed:    4.15,     // should be able to cross court horizontally in 4 seconds, at starting speed ...
